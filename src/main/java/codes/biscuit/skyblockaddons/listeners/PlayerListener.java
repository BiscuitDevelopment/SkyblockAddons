...
public class PlayerListener {
    ...
    private final Set<String> legendarySeaCreatureMessages = new HashSet<>(Arrays.asList("The Water Hydra has come to test your strength.", "The Sea Emperor arises from the depths...", "What is this creature!?"));
