...
public class ModelEndermanHook {
    ...
    public static void setEndermanColor() {
        ...
        if (main.getUtils().isOnSkyblock() && (location == Location.DRAGONS_NEST || location == Location.ZEALOT_BRUISER_HIDEOUT) && main.getConfigValues().isEnabled(Feature.CHANGE_ZEALOT_COLOR)) {
