            ...
            if (nameMatches(methodName,"playSound", "func_148611_c")) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (abstractNode instanceof MethodInsnNode && abstractNode.getOpcode() == Opcodes.INVOKESPECIAL) {
                        ...
                        if (nameMatches(methodInsnNode.owner,"net/minecraft/client/audio/SoundManager") && nameMatches(methodInsnNode.name, "getNormalizedVolume", "func_148594_a")) {
                            methodNode.instructions.insertBefore(abstractNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "codes/biscuit/skyblockaddons/asm/hooks/SoundManagerHook", "getNormalizedVolume",
                                    "(Lnet/minecraft/client/audio/SoundManager;Lnet/minecraft/client/audio/ISound;Lnet/minecraft/client/audio/SoundPoolEntry;Lnet/minecraft/client/audio/SoundCategory;)F",
