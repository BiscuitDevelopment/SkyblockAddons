...
public enum Message {
    ...
    COMMAND_USAGE_COPY_BLOCK_DATA(MessageObject.COMMAND_USAGE, "sba.copyBlockData"),
    COMMAND_USAGE_COPY_BLOCK_DATA_DISABLED(MessageObject.COMMAND_USAGE, "sba.copyBlockData.disabled"),
    COMMAND_USAGE_COPY_BLOCK_DATA_ENABLED(MessageObject.COMMAND_USAGE, "sba.copyBlockData.enabled"),
