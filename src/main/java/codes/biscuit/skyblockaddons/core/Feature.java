...
public enum Feature {
    ...
    CRIMSON_STACKS(216, Message.SETTING_CRIMSON_STACKS, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD), false),
    HIDE_TRUE_DEFENSE(217, Message.SETTING_HIDE_TRUE_DEFENSE, new GuiFeatureData(ColorCode.RED), false),
