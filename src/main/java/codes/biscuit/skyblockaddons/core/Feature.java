...
public enum Feature {
    ...
    MAGMA_BOSS_TIMER(8, Message.SETTING_MAGMA_BOSS_TIMER, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD, EnumUtils.AnchorPoint.TOP_RIGHT, false, -30, 11), false, EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES),
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    SKILL_DISPLAY(54, Message.SETTING_COLLECTION_DISPLAY, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.AQUA, EnumUtils.AnchorPoint.BOTTOM_MIDDLE, 0, -66), false, EnumUtils.FeatureSetting.EXPANDED),
    ...
    ENDSTONE_PROTECTOR_DISPLAY(84, Message.SETTING_ENDSTONE_PROTECTOR_DISPLAY, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.WHITE, EnumUtils.AnchorPoint.TOP_RIGHT, -184, 11), false),
    ...
    BAIT_LIST(93, Message.SETTING_BAIT_LIST, new GuiFeatureData(EnumUtils.DrawType.BAIT_LIST_DISPLAY, ColorCode.AQUA, EnumUtils.AnchorPoint.TOP_LEFT, 36, 100), true),
    ...
    SLAYER_TRACKERS(100, Message.SETTING_SLAYER_TRACKER, new GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE, EnumUtils.AnchorPoint.BOTTOM_LEFT, 30, -5), false, EnumUtils.FeatureSetting.SLAYER_ZOMBIE, EnumUtils.FeatureSetting.SLAYER_SPIDER, EnumUtils.FeatureSetting.SLAYER_WOLF, EnumUtils.FeatureSetting.COLOUR_BY_RARITY, EnumUtils.FeatureSetting.SHOW_ICONS, EnumUtils.FeatureSetting.EXPANDED),
    ...
    SLAYER_TRACKERS_SHOW_ICONS(105, null, false),
    SLAYER_TRACKERS_EXPANDED(106, null, false),
    DRAGON_STATS_TRACKER(107, Message.SETTING_DRAGON_STATS_TRACKER, new GuiFeatureData(EnumUtils.DrawType.DRAGON_STATS_TRACKER, ColorCode.WHITE, EnumUtils.AnchorPoint.TOP_RIGHT, -150, 50), true, EnumUtils.FeatureSetting.COLOUR_BY_RARITY, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
    DRAGON_STATS_TRACKER_COLOUR_BY_RARITY(108, null, true),
    DRAGON_STATS_TRACKER_NEST_ONLY(109, null, false),
    ZEALOTS_NEST_ONLY(110, null, false),
    SHOW_PERSONAL_COMPACTOR_PREVIEW(111, null, false),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            SLAYER_TRACKERS_EXPANDED, DRAGON_STATS_TRACKER_NEST_ONLY, ZEALOTS_NEST_ONLY, SHOW_PERSONAL_COMPACTOR_PREVIEW);
