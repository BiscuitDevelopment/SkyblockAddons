...
public enum Feature {
    ...
    FETCHUR_TODAY(174, Message.SETTING_SHOW_FETCHUR_TODAY, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GREEN), false, EnumUtils.FeatureSetting.SHOW_FETCHUR_ITEM_NAME, EnumUtils.FeatureSetting.SHOW_FETCHUR_ONLY_IN_DWARVENS, EnumUtils.FeatureSetting.SHOW_FETCHUR_INVENTORY_OPEN_ONLY, EnumUtils.FeatureSetting.WARN_WHEN_FETCHUR_CHANGES),
    SHOW_FETCHUR_ONLY_IN_DWARVENS(175, Message.SETTING_SHOW_FETCHUR_IN_DWARVEN_ONLY, true),
    SHOW_FETCHUR_ITEM_NAME(176, Message.SETTING_SHOW_FETCHUR_TODAY, false),
    SHOW_FETCHUR_INVENTORY_OPEN_ONLY(177, Message.SETTING_SHOW_FETCHUR_INVENTORY_OPEN_ONLY, false),
    WARN_WHEN_FETCHUR_CHANGES(178, Message.SETTING_WARN_WHEN_FETCHUR_CHANGES, new GuiFeatureData(ColorCode.RED), false),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            SHOW_SALVAGE_ESSENCES_COUNTER, SHOW_FETCHUR_ONLY_IN_DWARVENS, SHOW_FETCHUR_ITEM_NAME, SHOW_FETCHUR_INVENTORY_OPEN_ONLY, WARN_WHEN_FETCHUR_CHANGES);
    ...
    ROCK_PET_TRACKER,DOLPHIN_PET_TRACKER,DUNGEONS_SECRETS_DISPLAY,SKILL_PROGRESS_BAR,FETCHUR_TODAY));
