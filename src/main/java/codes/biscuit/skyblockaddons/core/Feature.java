...
public enum Feature {
    ...
    HIDE_WHEN_NOT_IN_CRIMSON(221, null, false),
    INFERNO_SLAYER_TRACKER(222, "settings.infernoSlayerTracker", new GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE), false, EnumUtils.FeatureSetting.COLOUR_BY_RARITY, EnumUtils.FeatureSetting.TEXT_MODE, EnumUtils.FeatureSetting.HIDE_WHEN_NOT_IN_CRIMSON),
    INFERNO_COLOR_BY_RARITY(223, null, false),
    INFERNO_TEXT_MODE(224, null, true),
