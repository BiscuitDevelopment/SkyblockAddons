...
public enum Feature {
    ...
    OUTBID_ALERT(146, Message.SETTING_OUTBID_ALERT,true,EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            HIDE_WHEN_NOT_IN_CRYPTS, SHOW_PERSONAL_COMPACTOR_PREVIEW, SHOW_SKILL_PERCENTAGE_INSTEAD_OF_XP, SHOW_SKILL_XP_GAINED, OUTBID_ALERT_IN_OTHER_GAMES);
