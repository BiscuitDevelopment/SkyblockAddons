...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    DRAGON_STATS_TRACKER(106, Message.SETTING_DRAGON_STATS_TRACKER, new GuiFeatureData(EnumUtils.DrawType.DRAGON_STATS_TRACKER, ColorCode.WHITE, EnumUtils.AnchorPoint.TOP_RIGHT, -150, 50), true, EnumUtils.FeatureSetting.COLOUR_BY_RARITY, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
    DRAGON_STATS_TRACKER_COLOUR_BY_RARITY(107, null, true),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            SLAYER_TRACKERS_COLOUR_BY_RARITY, SLAYER_TRACKERS_SHOW_ICONS, DRAGON_STATS_TRACKER_COLOUR_BY_RARITY, DRAGON_STATS_TRACKER_NEST_ONLY,
