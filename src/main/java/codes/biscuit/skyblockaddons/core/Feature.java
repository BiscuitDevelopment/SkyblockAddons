...
public enum Feature {
    ...
    CULT_STARFALL_TIMER(221, "settings.cultStarfallTimer", new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD), false, EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES, EnumUtils.FeatureSetting.MALMAR_ALSO_TIMER),
    SHOW_CULT_STARFALL_TIMER_IN_OTHER_GAMES(222, null, false),
    MALMAR_ALSO_TIMER(223, null , true),
