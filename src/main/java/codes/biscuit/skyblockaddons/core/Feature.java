...
public enum Feature {
    ...
    ZEALOT_COUNTER(66, "settings.zealotCounter", new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA), false, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
    TICKER_CHARGES_DISPLAY(67, "settings.tickerChargesDisplay", new GuiFeatureData(EnumUtils.DrawType.TICKER, null), false),
    TAB_EFFECT_TIMERS(68, "settings.tabEffectTimers", new GuiFeatureData(EnumUtils.DrawType.TAB_EFFECT_TIMERS, ColorCode.WHITE), true, EnumUtils.FeatureSetting.HIDE_NIGHT_VISION_EFFECT, EnumUtils.FeatureSetting.SORT_TAB_EFFECT_TIMERS),
    NO_ARROWS_LEFT_ALERT(69, "settings.noArrowsLeftAlert", new GuiFeatureData(ColorCode.RED), false),
    HIDE_NIGHT_VISION_EFFECT_TIMER(70, "settings.hideNightVisionEffectTimer", null, true),
    CAKE_BAG_PREVIEW(71, "settings.showCakeBagPreview", null, true),
    REPEAT_FULL_INVENTORY_WARNING(73, null, true),
    SORT_TAB_EFFECT_TIMERS(74, "settings.sortTabEffectTimers", null, false),
    ...
    SHOW_TOTAL_ZEALOT_COUNT(77, "settings.showTotalZealotCount", new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA), true, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
    SHOW_SUMMONING_EYE_COUNT(78, "settings.showSummoningEyeCount", new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA), true, EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY),
    ...
    PLAYER_SYMBOLS_IN_CHAT(216, "settings.addPlayerSymbolsToChat", null, false),
