...
public enum Feature {
    ...
    OUTBID_ALERT(143, Message.SETTING_OUTBID_ALERT,true,EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            HIDE_WHEN_NOT_IN_CRYPTS, SHOW_PERSONAL_COMPACTOR_PREVIEW, OUTBID_ALERT_IN_OTHER_GAMES);
    ...
    @Getter private static final Set<Feature> guiFeatures = new LinkedHashSet<>(Arrays.asList(MAGMA_BOSS_TIMER, MANA_BAR, MANA_TEXT, DEFENCE_ICON, DEFENCE_TEXT,
            ...
            ROCK_PET_TRACKER, DOLPHIN_PET_TRACKER, DUNGEONS_SECRETS_DISPLAY));
