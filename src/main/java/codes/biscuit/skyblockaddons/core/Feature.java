...
public enum Feature {
    ...
    SHOW_COMPACT_COUNTER(99, Message.SETTINGS_SHOW_COMPACT_COUNTER, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD, EnumUtils.AnchorPoint.TOP_LEFT, 50, 25),false),
    ...
    @Getter private static final Set<Feature> guiFeatures = new LinkedHashSet<>(Arrays.asList(MAGMA_BOSS_TIMER, MANA_BAR, MANA_TEXT, DEFENCE_ICON, DEFENCE_TEXT,
            ...
            SHOW_AVERAGE_ZEALOTS_PER_EYE, BIRCH_PARK_RAINMAKER_TIMER, COMBAT_TIMER_DISPLAY, ENDSTONE_PROTECTOR_DISPLAY, BAIT_LIST, SHOW_COMPACT_COUNTER));
