...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    SHOW_BASE_STAT_BOOST_PERCENTAGE(112, Message.SHOW_BASE_STAT_BOOST_PERCENTAGE, null, false, EnumUtils.FeatureSetting.COLOUR_BY_RARITY),
    SHOW_BASE_STAT_BOOST_PERCENTAGE_COLOUR_BY_RARITY(113, Message.SETTING_COLOUR_BY_RARITY, null, true),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            REPEAT_SLAYER_BOSS_WARNING, SHOW_BASE_STAT_BOOST_PERCENTAGE_COLOUR_BY_RARITY);
