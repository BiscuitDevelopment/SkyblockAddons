...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    SLAYER_TRACKERS(100, Message.SETTING_SLAYER_TRACKER, new GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE, EnumUtils.AnchorPoint.BOTTOM_LEFT, 20, -10), false, EnumUtils.FeatureSetting.SLAYER_ZOMBIE, EnumUtils.FeatureSetting.SLAYER_SPIDER, EnumUtils.FeatureSetting.SLAYER_WOLF, EnumUtils.FeatureSetting.COLOUR_BY_RARITY),
    ...
    SHOW_RARITY_UPGRADED(110, Message.SETTING_SHOW_RARITY_UPGRADED, new GuiFeatureData(ColorCode.RED, true), false),
