...
public enum Feature {
    ...
    SKILL_DISPLAY(54, Message.SETTING_COLLECTION_DISPLAY, new GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.AQUA), false, EnumUtils.FeatureSetting.EXPANDED, EnumUtils.FeatureSetting.SHOW_SKILL_IN_PERCENTAGE, EnumUtils.FeatureSetting.DISABLE_ADDED_EXP),
    ...
    SKILL_BAR(143, Message.SETTING_SKILL_BAR, new GuiFeatureData(EnumUtils.DrawType.BAR, ColorCode.GREEN), false),
    SHOW_SKILL_PERCENTAGE(144, Message.SETTING_SHOW_SKILL_IN_PERCENTAGE, true),
    DISABLE_ADDED_EXP(145, Message.SETTING_DISABLE_ADDED_EXP, true),
    ...
    @Getter private static final Set<Feature> guiFeatures = new LinkedHashSet<>(Arrays.asList(MAGMA_BOSS_TIMER, MANA_BAR, MANA_TEXT, DEFENCE_ICON, DEFENCE_TEXT,
            ...
            ROCK_PET_TRACKER, DOLPHIN_PET_TRACKER, DUNGEONS_SECRETS_DISPLAY, SKILL_BAR));
