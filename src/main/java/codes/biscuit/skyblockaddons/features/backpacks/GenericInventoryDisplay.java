...
public class GenericInventoryDisplay {
    ...
    protected final Rectangle bottomLeft = new Rectangle(0, 38, 7, 45);
    protected final Rectangle bottomMiddle = new Rectangle(8, 38, 26, 45);
    protected final Rectangle bottomRight = new Rectangle(27, 38, 34, 45);
    protected final Rectangle sideLeft = new Rectangle(0, 18, 7, 36);
    protected final Rectangle sideRight = new Rectangle(27, 18, 34, 36);
    protected final Rectangle slot = new Rectangle(35, 8, 53, 36);
    protected final Rectangle blank = new Rectangle(8, 18, 26, 36);
