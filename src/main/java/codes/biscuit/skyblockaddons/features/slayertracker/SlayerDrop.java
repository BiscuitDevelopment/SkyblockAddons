...
public enum SlayerDrop {
    ...
    // Revenant Drops
    REVENANT_FLESH(Items.rotten_flesh, "Revenant Flesh", "REVENANT_FLESH",ItemRarity.UNCOMMON),
    ...
    SMITE_SIX(Items.enchanted_book, "Enchanted Book", "ENCHANTED_BOOK", ItemRarity.RARE),
    ...
    REVENANT_CATALYST("Revenant Catalyst", "REVENANT_CATALYST", ItemRarity.EPIC, "5bf9191d-dcdf-3c0f-aff9-7fcc5cb0a001", "b88cfafa5f03f8aef042a143799e964342df76b7c1eb461f618e398f84a99a63"),
    ...
    // Tarantula Drops
    TARANTULA_WEB(Items.string, "Tarantula Web", "TARANTULA_WEB", ItemRarity.UNCOMMON),
    ...
    BANE_OF_ARTHROPODS_SIX(Items.enchanted_book, "Enchanted Book", "ENCHANTED_BOOK", ItemRarity.RARE),
    ...
    // Sven Drops
    WOLF_TOOTH(Items.ghast_tear, "Wolf Tooth", "WOLF_TOOTH", ItemRarity.UNCOMMON),
    HAMSTER_WHEEL(Item.getItemFromBlock(Blocks.trapdoor), "Hamster Wheel", "HAMSTER_WHEEL", ItemRarity.RARE),
    ...
    CRITICAL_SIX(Items.enchanted_book, "Enchanted Book", "ENCHANTED_BOOK", ItemRarity.RARE),
