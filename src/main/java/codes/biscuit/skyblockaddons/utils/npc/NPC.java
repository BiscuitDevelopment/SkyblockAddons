...
enum NPC {
    ...
    BAZAAR("Bazaar", 32, 71, -79, asList(Tag.PLAYER, Tag.MERCHANT), asList(Location.VILLAGE, Location.BAZAAR)),
    ...
    WARREN("Warren" 37,71,-85, asList(Tag.PLAYER, Tag.MERCHANT), asList(Location.VILLAGE, Location.BAZAAR)),
