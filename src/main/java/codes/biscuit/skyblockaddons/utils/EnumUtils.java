...
public class EnumUtils {
    ...
    public enum FeatureSetting {
        ...
        SHOW_FETCHUR_ONLY_IN_DWARVENS(SETTING_SHOW_FETCHUR_IN_DWARVEN_ONLY, 175),
        SHOW_FETCHUR_ITEM_NAME(SETTING_SHOW_FETCHUR_ITEM_NAME, 176),
        SHOW_FETCHUR_INVENTORY_OPEN_ONLY(SETTING_SHOW_FETCHUR_INVENTORY_OPEN_ONLY, 177),
        WARN_WHEN_FETCHUR_CHANGES(SETTING_WARN_WHEN_FETCHUR_CHANGES, 178),
    ...
    public enum FeatureCredit {
        ...
        PEDRO9558("Pedro9558","github.com/Pedro9558", Feature.FETCHUR_TODAY);
