...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    DISABLE_MAGICAL_SOUP_MESSAGES(59, Message.SETTING_DISABLE_MAGICAL_SOUP_MESSAGE, true),
    ...
    private static final Set<Feature> FEATURES = new LinkedHashSet<>(Arrays.asList(SHOW_ENCHANTMENTS_REFORGES, SHOW_BACKPACK_PREVIEW, CRAFTING_PATTERNS,
            ...
            JUNGLE_AXE_COOLDOWN, MINION_DISABLE_LOCATION_WARNING, SHOW_ITEM_COOLDOWNS, ONLY_MINE_ORES_DEEP_CAVERNS, SUMMONING_EYE_ALERT, AVOID_BREAKING_BOTTOM_SUGAR_CANE, DISABLE_MAGICAL_SOUP_MESSAGES));
