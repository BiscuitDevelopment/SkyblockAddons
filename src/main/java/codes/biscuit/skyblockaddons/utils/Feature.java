...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    BOSS_APPROACH_ALERT(68, Message.SETTING_BOSS_APPROACH_ALERT, false),
...
//    ANCHOR_POINT(-1, Message.SETTING_ANCHOR_POINT, false),
    ...
    private static final Set<Feature> FEATURES = new LinkedHashSet<>(Arrays.asList(SHOW_ENCHANTMENTS_REFORGES, SHOW_BACKPACK_PREVIEW, CRAFTING_PATTERNS,
            ...
            JUNGLE_AXE_COOLDOWN, MINION_DISABLE_LOCATION_WARNING, SHOW_ITEM_COOLDOWNS, ONLY_MINE_ORES_DEEP_CAVERNS, ONLY_MINE_VALUABLES_NETHER, SUMMONING_EYE_ALERT,
            AVOID_BREAKING_BOTTOM_SUGAR_CANE, DISABLE_MAGICAL_SOUP_MESSAGES, BOSS_APPROACH_ALERT));
