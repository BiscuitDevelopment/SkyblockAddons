...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    COLLECTION_DISPLAY(54, Message.SETTING_COLLECTION_DISPLAY, new GuiFeatureData(EnumUtils.DrawType.TEXT, ConfigColor.AQUA, EnumUtils.AnchorPoint.BOTTOM_MIDDLE, 0, -66), false),
