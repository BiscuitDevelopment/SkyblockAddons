...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    POTION_EFFECT_TIMER(68, Message.SETTING_POTION_EFFECT_TIMERS, new GuiFeatureData(EnumUtils.DrawType.POTION_EFFECT_TIMER, EnumUtils.AnchorPoint.BOTTOM_MIDDLE, 210, -27), false),
...
//    ANCHOR_POINT(-1, Message.SETTING_ANCHOR_POINT, false),
    ...
    private static Set<Feature> GUI_FEATURES = new LinkedHashSet<>(Arrays.asList(MAGMA_BOSS_TIMER, MANA_BAR, MANA_TEXT, DEFENCE_ICON, DEFENCE_TEXT,
            ...
            POWER_ORB_STATUS_DISPLAY, ZEALOT_COUNTER, TICKER_CHARGES_DISPLAY, POTION_EFFECT_TIMER));
