...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    MAKE_ENDERCHESTS_GREEN_IN_END(40, Message.SETTING_MAKE_ENDERCHESTS_IN_END_GREEN, new GuiFeatureData(ConfigColor.GREEN), false),
    ...
    ONLY_MINE_ORES_DEEP_CAVERNS(56, Message.SETTING_ONLY_MINE_ORES_DEEP_CAVERNS, null, true),
    REVENANT_INDICATOR(57, Message.SETTING_REVENANT_INDICATOR, new GuiFeatureData(EnumUtils.DrawType.REVENANT_PROGRESS, ConfigColor.AQUA, EnumUtils.AnchorPoint.BOTTOM_RIGHT, -84, -29), true),
    ...
    private static final Set<Feature> FEATURES = new LinkedHashSet<>(Arrays.asList(SHOW_ENCHANTMENTS_REFORGES, SHOW_BACKPACK_PREVIEW, CRAFTING_PATTERNS,
            ...
            DONT_OPEN_PROFILES_WITH_BOW, STOP_DROPPING_SELLING_RARE_ITEMS, MAKE_ENDERCHESTS_GREEN_IN_END, SUMMONING_EYE_ALERT,
            ...
            JUNGLE_AXE_COOLDOWN, MINION_DISABLE_LOCATION_WARNING, SHOW_ITEM_COOLDOWNS, ONLY_MINE_ORES_DEEP_CAVERNS, AVOID_BREAKING_BOTTOM_SUGAR_CANE));
