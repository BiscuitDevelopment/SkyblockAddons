...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // removed
    ...
    NO_ARROWS_LEFT_ALERT(64, Message.SETTING_NO_ARROWS_LEFT_ALERT, new GuiFeatureData(ConfigColor.RED), false),
...
//    ANCHOR_POINT(-1, Message.SETTING_ANCHOR_POINT, false),
    ...
    private static final Set<Feature> FEATURES = new LinkedHashSet<>(Arrays.asList(SHOW_ENCHANTMENTS_REFORGES, SHOW_BACKPACK_PREVIEW, CRAFTING_PATTERNS,
            ...
            JUNGLE_AXE_COOLDOWN, MINION_DISABLE_LOCATION_WARNING, SHOW_ITEM_COOLDOWNS, ONLY_MINE_ORES_DEEP_CAVERNS, ONLY_MINE_VALUABLES_NETHER, SUMMONING_EYE_ALERT, AVOID_BREAKING_BOTTOM_SUGAR_CANE, NO_ARROWS_LEFT_ALERT));
